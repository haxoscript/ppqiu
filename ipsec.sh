...
wget -O /usr/bin/addl2tp https://github.com/haxoscript/ppqiu/raw/main/addl2tp.sh && chmod +x /usr/bin/addl2tp
wget -O /usr/bin/dell2tp https://github.com/haxoscript/ppqiu/raw/main/dell2tp.sh && chmod +x /usr/bin/dell2tp
wget -O /usr/bin/xp-l2tp https://github.com/haxoscript/ppqiu/raw/main/xp-l2tp.sh && chmod +x /usr/bin/xp-l2tp
wget -O /usr/bin/addpptp https://github.com/haxoscript/ppqiu/raw/main/addpptp.sh && chmod +x /usr/bin/addpptp
wget -O /usr/bin/delpptp https://github.com/haxoscript/ppqiu/raw/main/delpptp.sh && chmod +x /usr/bin/delpptp
wget -O /usr/bin/xp-pptp https://github.com/haxoscript/ppqiu/raw/main/xp-pptp.sh && chmod +x /usr/bin/xp-pptp
wget -O /usr/bin/renewpptp https://github.com/haxoscript/ppqiu/raw/main/renewpptp.sh && chmod +x /usr/bin/renewpptp
wget -O /usr/bin/renewl2tp https://github.com/haxoscript/ppqiu/raw/main/renewl2tp.sh && chmod +x /usr/bin/renewl2tp
